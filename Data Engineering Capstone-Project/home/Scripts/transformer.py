...
class Transformer:
    ...
    def transform_immigrants(immigrants):
        """
        Transform immigration dataset on order to get arrival date in different columns (year, month, day) 
        for partitioning the dataset.
        :param immigrants: immigration dataset
        :return: immigration dataset transformed
        """
